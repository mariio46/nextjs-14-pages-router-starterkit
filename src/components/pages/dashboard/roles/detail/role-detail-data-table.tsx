...
interface RoleDetailDataTableProps<TData, TValue> {
...
const RoleDetailDataTable = <TData, TValue>({
    columns,
    data,
    isLoading,
    isError,
    ...
    tableTitle,
}: RoleDetailDataTableProps<TData, TValue>) => {
        ...
        <Card>
            <CardContent>
                <div className='flex items-center justify-between gap-2 py-4'>
                    <h3 className='text-base font-semibold'>{tableTitle}</h3>
                    <Input
