    ...
    ({ className, children, ...props }, ref) => {
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    'flex flex-wrap gap-1 py-2 px-3 items-center border border-muted rounded-md bg-background',
                    className,
                )}
                {...props}>
                {value.map((item, index) => (
                    <Badge
                        ...
                        <button
                            ...
                            <IconX className='size-3 hover:stroke-destructive' />
                        </button>
                    </Badge>
                ))}
                {children}
...
>(({ className, value, children, ...props }, ref) => {
    ...
    return (
        <CommandItem
            ...
            onMouseDown={mousePreventDefault}>
            {children}
            {isIncluded && <IconCheck className='size-4' />}
        </CommandItem>
    );
});
